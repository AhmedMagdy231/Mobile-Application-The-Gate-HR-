class GetAllExcusesManagement{
  bool? hasError;
  List<dynamic>? errors;
  List<dynamic>? messages;
  Data? data;

  GetAllExcusesManagement({this.hasError, this.errors, this.messages, this.data});

  GetAllExcusesManagement.fromJson(Map<String, dynamic> json) {
...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    hremployeeAllowanceCommunications = json['hremployee_allowance_communications'];
